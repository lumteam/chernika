...
class YML {
    ...
    public static function exportYml( $SETUP_FILE_NAME, $domen, $utm_campaign = '', $withUtm = true, $siteId = 's1', $minPrice = 0, $disableBrands = '', $onlyChecked = false ) {
        ...
        if ( $fp = @fopen($SETUP_FILE_NAME, "wb") )
        {
            ...
            //Спортивные очки
            $arFilter = ['IBLOCK_ID' => IBLOCK_ID__CATALOG_2, 'ACTIVE' => 'Y', 'ACTIVE_DATE' => 'Y', 'SECTION_ID' => SECTION_ID__CATALOG_3, 'INCLUDE_SUBSECTIONS' => 'Y', '!ID' => $idsSolnce];
            ...
            $errorMessage = isset($error['message']) ? $error['message'] : 'Неизвестная ошибка';
    ...
    public static function exportYmlNew( $SETUP_FILE_NAME, $domen, $utm_campaign = '', $withUtm = true, $siteId = 's1', $minPrice = 0, $disableBrands = '', $onlyChecked = false ) {
        $disabledBrands = explode(',',$disableBrands);
        ...
        if ( $fp = @fopen($SETUP_FILE_NAME, "wb") )
        {
            ...
            // ОЧКИ
            $arFilter = ['IBLOCK_ID' => IBLOCK_ID__CATALOG_2, 'ACTIVE' => 'Y', 'ACTIVE_DATE' => 'Y', 'INCLUDE_SUBSECTIONS' => 'Y'];
