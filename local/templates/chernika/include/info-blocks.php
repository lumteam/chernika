<div class="info-block">
    <p class="tile">Мы&nbsp;гарантируем лучшую цену на&nbsp;оригинальные брендовые оправы среди салонов города. Если Вы&nbsp;нашли дешевле&nbsp;&mdash; позвоните нам, мы&nbsp;сделаем индивидуальное предложение для Вас. <span class="tile__close"><img src="<?=SITE_TEMPLATE_PATH?>/img/close-white.svg" alt="Закрыть"></span></p>
...
<div class="info-block">
    <p class="tile">Мы покупаем брендовые очки только у официальных дистрибьюторов. Все очки имеют сертификат соответствия и регистрационное удостоверение.<a href="#" class="tile__close"><img src="<?=SITE_TEMPLATE_PATH?>/img/close-white.svg" alt=""></a></p>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42" height="42" viewbox="0 0 42 42">
        <defs>
