...
if($arResult['NavPageCount'] < $_GET['PAGEN_'.$arResult["NavNum"]])
{
    $protocol = stripos($_SERVER['SERVER_PROTOCOL'],'https') === true ? 'https://' : 'http://';
	$url = $protocol . $_SERVER['HTTP_HOST'].substr($_SERVER['REQUEST_URI'],0,strpos($_SERVER['REQUEST_URI'],'?'));
...
<div class="js-catalog_pagination">
    ...
    <?if ( !empty($nextUrl) ):?>
        <div class="row d-xl-none"><a href="<?=$nextUrl?>" class="show-all-btn js-load_more">Показать еще</a></div>
    <?endif;?>
</div>