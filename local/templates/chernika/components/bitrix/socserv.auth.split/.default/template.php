...
<div class="profile-content-item order-4">
    <h3 class="profile-content-item-title">Социальные сети</h3>
    <div class="profile-content-item-block">
        <p>Добавьте аккаунты ваших социальных сетей и используйте их при авторизации</p>
    </div>
    <?
