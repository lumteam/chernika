...
<?if($arResult["FORM_TYPE"] == "login"):?>
    <div id="login-modal" class="mfp-hide city-container login-form">
        ...
        <form class="login-form_modal" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
            <?
...
<?/*
        <div class="form-item">
            <a href="#" class="submit-btn button_transparent js-link_register_popup">Регистрация</a>
        </div>
*/?>
    </div>
<?endif?>
